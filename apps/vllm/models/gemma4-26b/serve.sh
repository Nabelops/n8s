...
# and drop them into place on boot. Cp-from-ConfigMap is intentionally a plain
# file copy rather than a bind mount so upstream directory contents stay intact.
